									...
									<ul class="user_profile_dd">
										<li>
											...
											<c:if test="${SdsLogin ne null && Login eq null}">
												<a class="dropdown-toggle" data-toggle="dropdown"><span
													class="name_user">${ NickLogin }</span></a>
												<div class="dropdown-menu">
															...
															<form>
																<div class="mb-3" style="margin: 1.5% 2%;">
																	<label for="exampleFormControlInput3"
																		class="form-label f_size24">지역</label> <input
																		type="text" class="form-control"
																		id="exampleFormControlInput3" placeholder="지역">
																</div>
																<div class="mb-3" style="margin: 1.5% 2%;">
																	<label for="exampleFormControlInput1"
																		class="form-label f_size24">제목</label> <input
																		type="text" class="form-control"
																		id="exampleFormControlInput1" placeholder="제목칸">
																</div>
																<div class="mb-3" style="margin: 1.5% 2%;">
																	...
																	<div class="left_alignment"
																		style="width: 50%; margin-bottom: 1.5%;">
																...
																<div class="mb-3" style="margin: 1.5% 2%;">
																	<div class="right_alignment">
																		<div class="right_button">
																			<a class="btn btn-xs detail_button">지원정책 작성</a>
																		</div>
																	</div>
																	<div class="left_alignment">
																		<div class="right_button">
																			<a href="advocacy.html"
																				class="btn btn-xs detail_button">목록보기</a>
																		</div>
																	</div>
																</div>
															</form>
								...
								<div class="container-fluid">
									<div class="footer">
										<p>
											...
											reserved.<br> <br> Distributed By: <a

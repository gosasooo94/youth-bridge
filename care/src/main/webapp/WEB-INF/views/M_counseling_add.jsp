										...
										<div class="row">
											...
											<div class="col-lg-3 col-md-6 col-sm-6"
												...
												<div class="table_price full margin_top20px">
													<form>
														<div class="mb-3" style="margin: 3% 2%;">
															<label for="exampleFormControlInput1"
																class="form-label f_size24">상담소명</label> <input
																type="text" class="aaa" id="exampleFormControlInput1"
																placeholder="상담소명">
														</div>
														<div class="mb-3" style="margin: 3% 2%;">
															<label for="exampleFormControlInput1"
																class="form-label f_size24">지역</label>
															<div action="#" class="position search_inbox"
																style="margin-bottom: 4%;">
																<div class="input-append">
																	<select name="" class="sr-select aaa"
																		style="border: 1px solid #898989; margin-bottom: 18px; width: 30%;">
																		<option>지역구</option>
																		<option>전시</option>
																		<option>문화</option>
																		<option>기타</option>
                                                   ...
                                                   <select name="" class="sr-select aaa"
																		style="border: 1px solid #898989; margin: 0px 35% 18px 3%; width: 30%;">
																		<option>상제지역</option>
																		<option>전시</option>
																		<option>문화</option>
																		<option>기타</option>
                                          ...
                                          <div class="mb-3" style="margin: 3% 2%;">
															<label
																class="form-label f_size24">상세주소</label> <input
																type="text" class="aaa" 
																placeholder="상담소 상세주소">
														</div>

                                          <div class="mb-3" style="margin: 3% 2%;">
															<label for="exampleFormControlInput1"
																class="form-label f_size24">전화번호</label>
															<div action="#" class="position search_inbox"
																style="margin-bottom: 4%;">
																<div class="input-append">
																	<input type="text" class="aaa" style="width: 28%; margin: 0 2.5% 0 2%;" placeholder="010">-
																	<input type="text" class="aaa" style="width: 28%; margin: 0 2.5% 0 2%;" placeholder="">-
																	<input type="text" class="aaa" style="width: 28%; margin: 0 2% 0 2%;" placeholder="">
																</div>
															</div>
														</div>

														<div class="mb-3" style="margin: 3% 2%;">
															<label class="form-label f_size24">상담소 사진</label>
															<div class="file-upload">
																<div class="file-select">
																	<div class="file-select-button" id="fileName">사진
																		선택</div>
																	<div class="file-select-name" id="noFile">사진이
																		없습니다</div>
														...
														<div class="mb-3" style="margin: 3% 2%;">
															<div class="right_alignment">
																<div class="right_button">
																	<a class="btn btn-xs detail_button">상담소 추가</a>
																</div>
															</div>

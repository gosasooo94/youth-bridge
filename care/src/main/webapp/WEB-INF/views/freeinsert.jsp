																			...
																			<div class="col-md-12">
																				<form action="createFreeBoard.do" method="post"
																					...
																					<div class="form-group filebox">
																						...
																						<label for="file" class="free_fo" style="width: 6.7%; margin-top: 5px;">업로드</label>
																						<input class="insert" type="file" name="file"
																							id="file" onchange="readURL1(this)" />
																						<input class="uploadName" value="파일선택" disabled="disabled" style="width: 92%; padding: 0.5em 0.7em;">

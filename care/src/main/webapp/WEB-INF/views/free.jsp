					    ...
					    <div class="row justify-content-start">
					        <div class="col-md-3 d-flex align-items-start">
					            <form action="searchFreeBoards.do" method="get" class="d-flex align-items-start">
					                ...
					                <button class="btn btn-primary" type="submit" id="search-button" style="flex: 0 0 auto;">검색</button>
					            </form>
					        </div>
					    </div>
					        ...
					        <div class="col-md-9">
					            <div class="text-end">
					                <c:if test="${not empty Login}">
					                    <a href="freeinsert.do?memcode=${MemLogin}" class="btn btn-success">글 작성하기</a>
					                </c:if>
					            </div>
					        </div>
					    </div>

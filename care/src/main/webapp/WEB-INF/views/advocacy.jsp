                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">                                         
                                          ...
                                          <div class="contact_inner">
                                             <div class="left">
                                                <h3>${support.supname }</h3>
                                          <!--    <span class="gray-label">지원대상자 : ${support.supage }</span> -->  
                                                <ul class="list-unstyled">
       									           <li><i class="fa fa-globe"></i>시행날짜 : ${support.supcheck }</li>
                                                  <li><i class="fa fa-bullhorn"></i>지원대상자 : ${support.supage }</li>
                                                   <li><i class="fa fa-bullhorn"></i>정책내용 : ${support.supcontent }</li>
                                                </ul>
                                             </div> 
                                               <div class="right">
                                                <div class="profile_contacts">
                                                    <img class="img-responsive" src=${support.suppoto } alt="#" />
                                                </div>
                                             </div>                                                                                      
                                             </div>
                                             <div class="bottom_list">
                                                <div class="right_button">
                                                   <button type="button" class="btn btn-primary btn-xs" onclick="window.open('${support.supurl }') ">

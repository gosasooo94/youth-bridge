...
<!-- site icon -->
<link rel="icon" href="resources/images/fevicon.png"
	type="resources/image/png" />
<!-- bootstrap css -->
					...
					<ul class="list-unstyled components">
						<li class="active"><a href="#advice" data-toggle="collapse"
							...
							<ul class="collapse list-unstyled" id="advice">
								<li><a href="counseling_center.do">> <span>상담소찾기</span></a>
								</li>
								<li><a href="reservation.do">> <span>예약하기</span></a></li>
								<li><a href="counselling_entry.do">> <span>상담하기</span></a>
								</li>
							</ul></li>
						<li><a href="#diary" data-toggle="collapse"
							aria-expanded="false" class="dropdown-toggle"><i><img
									src="resources/images/icon/diary-icon.png" style="width: 30px"></i><span>일기장</span></a>
							<ul class="collapse list-unstyled" id="diary">
								<li><a href="diary.do">> <span>일기</span></a></li>
								<li><a href="emotions.do">> <span>감정그래프</span></a></li>
							</ul></li>
						<li><a href="bucket_list.do"><i><img
									src="resources/images/icon/bucketList-icon.png"
									style="width: 30px"></i> <span>버킷리스트</span></a></li>
						<li><a href="#apps2" data-toggle="collapse"
							aria-expanded="false" class="dropdown-toggle"><i><img
									src="resources/images/icon/narration-icon.png"
									style="width: 30px"></i> <span>의사소통훈련</span></a>
						...
						<li><a href="freedom_board.do"><i><img
									...
									<ul class="user_profile_dd">
										<li><a class="dropdown-toggle" data-toggle="dropdown"><span
											...
											<div class="dropdown-menu">
												<a class="dropdown-item" href="profile.do">마이페이지</a> <a
													class="dropdown-item" href="#"><span>로그아웃</span> <i
																			...
																			<div class="col-10 "
																				...
																				<div class="row" style="height: 100%;">
																					<div
																						...
																						<button onclick="deleteBucket(${bucket.listcode}); class="right_alignment btn lettering_color" style="margin-left:5px;">삭제하기</button>
																					</div>
																					<div
																						class="col-12 align-items-center middle_alignment2">

...
<div class = "group" id = "popupGroup">
   ...
   <form id = "scheduleData" action="updateReserve.do">
      <div>
      ...
      <br/>
      <div class = "top">
         <input class = "subject" id = "subject" type = "text" name = "subject" placeholder = "내용을 입력해주세요.(25자)">
      </div>
      ...
      <div class = "domain">
         <input id="datetimepicker" autocomplete="off" type="text" >
      </div>
      ...
      <div class = "domain">
         <input id="datetimepicker1" autocomplete="off" type="text" >
      </div>
      
      <input class = "ok-button" type = "submit" value = "수정하기"></input>

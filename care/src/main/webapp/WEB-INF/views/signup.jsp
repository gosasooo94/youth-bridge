	...
	<div class="container">
		...
		<form method="post" action="saveMember.do" name="userinput"
			...
			<div class="sign-up">
				<div class="info">
					<p class="label">이름</p>
					<input type="text" class="insert" id="name" name="name"
				...
				<div class="info">
					<p class="label">아이디</p>
					<input class="insert" type="text" name="id" id="id" /><br /> <span
				...
				<div class="info">
					<p class="label">닉네임</p>
					<input class="insert" type="text" name="nick" id="nick" /><br /> <span

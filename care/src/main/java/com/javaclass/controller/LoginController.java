...
public class LoginController {
		...
		public String login(LoginVO vo, String pw, HttpSession session) {
			LoginVO login = loginService.getLogin(vo);
			if(login==null) return "redirect:/login.do";
			else {
				if(!login.getPw().contentEquals(pw)) {
		...
		public String sdsLogin(SdsLoginVO vo, String sdspw, HttpSession session) {
			SdsLoginVO sdslogin = sdsLoginService.sdsLogin(vo);
			if(sdslogin==null) return "redirect:/login.do";
			else {
